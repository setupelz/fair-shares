...
- **Global Carbon Budget 2024** (for `Emissions|CO2|AFOLU` at World level) — Friedlingstein et al. 2025, see `data/bunkers/gcb-2024/CITATION.md`
...
CC-BY-SA-4.0 confirmed as the intended licence by the dataset authors
(correspondence with Z. Nicholls et al., 2026-08-03): ShareAlike is deliberate,
protecting the F-gas and Montreal Protocol inversion inputs. Note the Zenodo
record metadata does not yet reflect this (DataCite lists CC0-1.0 on the concept
DOI; the version DOI has an empty rights list) — an upstream metadata fix, not a
licence ambiguity.
