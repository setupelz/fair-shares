...
NUMERIC_COLUMN_TYPES: dict[str, str] = {
    ...
    "warnings": "string",
    "pre-allocation-responsibility-weight": "float64",
    "capability-weight": "float64",
    "pre-allocation-responsibility-year": "Int64",
    "pre-allocation-responsibility-exponent": "float64",
    "capability-exponent": "float64",
    "capability-reference-year": "Int64",
    "cumulative-end-year": "Int64",
