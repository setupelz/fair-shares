...
#
# **Emission categories:**
# - `co2-ffi` - CO2 from fossil fuels and industry (default for RCB-based allocations)
...
# Ask yourself:
#
# 1. Which principles matter? Equal per capita? Historical responsibility? Capability?
...
#
# [Output guide](https://setupelz.github.io/fair-shares/user-guide/country-fair-shares/#output-files) | [Allocation concepts](https://setupelz.github.io/fair-shares/science/allocations/)
#
# ---
#
