...
#
# 1. **Equal per capita** - Operationalizes equal rights to atmosphere (annual shares)
# 2. **Adjusted** - Operationalizes historical responsibility + capability (CBDR-RC)
# 3. **Gini-adjusted** - Adds within-country inequality adjustment for subsistence protection
# 4. **Cumulative convergence** - Smooth transitions while preserving cumulative equity budgets
# 5. **Cumulative convergence adjusted** - Cumulative convergence + CBDR-RC adjustments
# 6. **Cumulative convergence Gini** - Cumulative convergence + subsistence protection
#
