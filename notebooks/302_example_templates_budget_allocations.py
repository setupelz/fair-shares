...
# - **Gini-adjusted** - Adds subsistence protection
#
...
#
# 1. **Equal per capita** - Egalitarianism
# 2. **Adjusted** - Operationalizes polluter-pays + ability-to-pay
# 3. **Gini-adjusted** - Adds subsistence emissions protection
#
